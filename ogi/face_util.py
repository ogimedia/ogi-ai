...
import ogi.globals
from ogi.typing import Frame, Face

import cv2
import numpy as np
from skimage import transform as trans
from ogi.capturer import get_video_frame
from ogi.utilities import resolve_relative_path, conditional_download
    ...
    with THREAD_LOCK_ANALYSER:
        if FACE_ANALYSER is None:
            if ogi.globals.CFG.force_cpu:
                ...
                FACE_ANALYSER = insightface.app.FaceAnalysis(name='buffalo_l', providers=ogi.globals.execution_providers)
            FACE_ANALYSER.prepare(ctx_id=0, det_size=(640, 640) if ogi.globals.default_det_size else (320,320))
