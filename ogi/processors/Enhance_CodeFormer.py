...
from ogi.typing import Face, Frame, FaceSet
from ogi.utilities import resolve_relative_path
...
class Enhance_CodeFormer():
    ...
    def Initialize(self, devicename:str):
        if self.model_codeformer is None:
            ...
            self.model_codeformer = onnxruntime.InferenceSession(model_path, None, providers=ogi.globals.execution_providers)
